...
#
# ph4_vivado.tcl: Tcl script for re-creating project 'EncryptDecrypt'
#
# Generated by Vivado on Tue Jun 30 11:03:48 +0300 2020
...
#
# 1. This project restoration tcl script (ph4_vivado.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/EEM464/2014_4_zynq_labs/EncryptDecrypt/EncryptDecrypt.srcs/sources_1/bd/encdec_design_1/hdl/encdec_design_1_wrapper.vhd"
#
...
set project_name "EncryptDecrypt"
...
set script_file "ph4_vivado.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../../../../EEM464/2014_4_zynq_labs/EncryptDecrypt"]"
...
set_property "ip_repo_paths" "[file normalize "HLS_ip/ip"]" $obj
...
set files [list \
 "[file normalize "hdl/encdec_design_1_wrapper.vhd"]"\
]
...
set file "hdl/encdec_design_1_wrapper.vhd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "encdec_design_1_wrapper" -objects $obj
...
# Proc to create BD encdec_design_1
proc cr_bd_encdec_design_1 { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name encdec_design_1
  ...
  if { $bCheckIPs == 1 } {
     set list_check_ips "\ 
  xilinx.com:hls:encryptdecrypt:1.0\
  ...
  # Create instance: encryptdecrypt_0, and set properties
  set encryptdecrypt_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:encryptdecrypt:1.0 encryptdecrypt_0 ]
 ...
 ] [get_bd_intf_pins /encryptdecrypt_0/s_axi_S_AXI_BUNDLE]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins encryptdecrypt_0/s_axi_S_AXI_BUNDLE] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins encryptdecrypt_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins encryptdecrypt_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs encryptdecrypt_0/s_axi_S_AXI_BUNDLE/Reg] SEG_encryptdecrypt_0_Reg
...
# End of cr_bd_encdec_design_1()
cr_bd_encdec_design_1 ""
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files encdec_design_1.bd ] 
