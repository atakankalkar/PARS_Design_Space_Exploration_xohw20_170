...
set Library     "hls"
set IPName      "encryptdecrypt"
set Version     "1.0"
set DisplayName "Encryptdecrypt"
set Revision    "2006161607"
...
set Interfaces {
    s_axi_S_AXI_BUNDLE {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_S_AXI_BUNDLE"
        param_prefix "C_S_AXI_S_AXI_BUNDLE"
        addr_bits "12"
        ...
        memories "a {base_address 512 range 512} c1 {base_address 1024 range 512} c2 {base_address 1536 range 512} m {base_address 2048 range 512} p {base_address 2560 range 512} r2 {base_address 3072 range 512}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
