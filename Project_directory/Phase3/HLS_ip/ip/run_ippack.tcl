...
set Library     "hls"
set IPName      "RLWE_enc2"
set Version     "1.0"
set DisplayName "Rlwe_enc2"
set Revision    "2006301157"
...
set Interfaces {
    s_axi_S_AXI_BUNDLE {
        ...
        memories "a {base_address 512 range 512} c1 {base_address 1024 range 512} c2 {base_address 1536 range 512} m {base_address 2048 range 512} p {base_address 2560 range 512}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
