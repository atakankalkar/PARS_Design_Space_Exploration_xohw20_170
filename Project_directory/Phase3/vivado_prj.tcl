...
#
# rlwe_enc2.tcl: Tcl script for re-creating project 'Rlwe_enc2'
#
# Generated by Vivado on Tue Jun 30 12:29:47 +0300 2020
...
#
# 1. This project restoration tcl script (rlwe_enc2.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/EEM464/2014_4_zynq_labs/Rlwe_enc2/Rlwe_enc2.srcs/sources_1/bd/rlwe_enc2_design_1/hdl/rlwe_enc2_design_1_wrapper.vhd"
#
...
set orig_proj_dir "[file normalize "$origin_dir/../../../../../../EEM464/2014_4_zynq_labs/Rlwe_enc2"]"
...
set files [list \
 "[file normalize "hdl/rlwe_enc2_design_1_wrapper.vhd"]"\
]
...
set file "hdl/rlwe_enc2_design_1_wrapper.vhd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "rlwe_enc2_design_1_wrapper" -objects $obj
...
# Proc to create BD rlwe_enc2_design_1
proc cr_bd_rlwe_enc2_design_1 { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name rlwe_enc2_design_1
  ...
  # Create instance: RLWE_enc2_1, and set properties
  set RLWE_enc2_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:RLWE_enc2:1.0 RLWE_enc2_1 ]

  set_property -dict [ list \
   CONFIG.NUM_READ_OUTSTANDING {1} \
   CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /RLWE_enc2_1/s_axi_S_AXI_BUNDLE]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins RLWE_enc2_1/s_axi_S_AXI_BUNDLE] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins RLWE_enc2_1/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins RLWE_enc2_1/ap_rst_n] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_reset [get_bd_pins rst_ps7_0_100M/peripheral_reset]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs RLWE_enc2_1/s_axi_S_AXI_BUNDLE/Reg] SEG_RLWE_enc2_1_Reg
...
# End of cr_bd_rlwe_enc2_design_1()
cr_bd_rlwe_enc2_design_1 ""
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files rlwe_enc2_design_1.bd ] 
