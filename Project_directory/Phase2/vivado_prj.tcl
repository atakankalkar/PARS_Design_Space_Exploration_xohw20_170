...
#
# vivado_prj.tcl: Tcl script for re-creating project 'rlwe_dec2_ph2'
#
# Generated by Vivado on Tue Jun 30 13:43:43 +0300 2020
...
#
# 1. This project restoration tcl script (vivado_prj.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/EEM464/2014_4_zynq_labs/rlwe_dec2_ph2/rlwe_dec2_ph2.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.vhd"
#
...
set project_name "rlwe_dec2_ph2"
...
set script_file "vivado_prj.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../../../../EEM464/2014_4_zynq_labs/rlwe_dec2_ph2"]"
...
proc cr_bd_design_1 { parentCell } {
  ...
  # Create instance: RLWE_enc2_0, and set properties
  set RLWE_enc2_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:RLWE_enc2:1.0 RLWE_enc2_0 ]
 ...
 ] [get_bd_intf_pins /RLWE_enc2_0/s_axi_S_AXI_BUNDLE]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins RLWE_enc2_0/s_axi_S_AXI_BUNDLE] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins RLWE_enc2_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins RLWE_enc2_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs RLWE_enc2_0/s_axi_S_AXI_BUNDLE/Reg] SEG_RLWE_enc2_0_Reg
